...
<div class="howtocontribute-body">
    ...
    <div class="sidenav-content">
        ...
        <br><br>
        To create an account, navigate to <a href="https://github.com"> GitHub</a> and follow the instructions to sign-up. (The GitHub account is your personal account and remains your account even after you stop working for Microsoft.
        <br><br>
        Once you have a GitHub account, instructions to link your GitHub and Microsoft account can be found <a href=" https://repos.opensource.microsoft.com/"> here</a>. Linking will give you access to the Microsoft Organization on GitHub. (This is where all the IP is located.)
        </span>
        <div id="how-to-contribute" class="howtocontribute-subtitle">How to contribute (step by step)</div>
        <ol>
            <li>Satisfy the prerequisites above</li>
            <li>Access the DS Toolkit repo with the accelerator of interest </li>
            <li>If you want to contribute to an <i>existing</i> one:
                <ol type="a">
                    <li>Check for open issues and choose one</li>
                    <li>Assign it to yourself</li>
                    <li>Create a branch with the your_initials/feature/issue name (please pay attention to nomenclature to avoid confusion) </li>
            ...
            <li>If you want to create a <i>new</i> accelerator:
                <ol type="a">
        ...
        <span style="margin-top:30px; line-height: 35px;"><b>NB</b>. Within the github repo, refer to the <a href="https://github.com/microsoft/dstoolkit-web/blob/gh-pages/HowToCreateAcceleratorPage.md"> step by step guide</a> for a thorough explanation.</span>
        ...
        <div style="border-top: 1px solid #D2D2D2;margin-top: 50px;">
            ...
            <div id="50-72-rule" style="font-weight: 600; margin-top: 30px; background-color:#e6ebef;">The 50/72 rule</div>
            <span style="margin-top:30px; line-height: 35px;">Write conventional Git commit messages.</span>
            <ul style="line-height: 35px;">
                <li>Write a summary in the imperative, no longer than 50 characters.</li>
                <li>If you add more text, leave the next link blank.</li>
                <li>You can add as much extra text as you’d like, but format it no longer than 72 characters.</li>
            ...
            <div id="new-code-base" style="font-weight: 600; margin-top: 30px;background-color:#e6ebef;">Checklist for a new code base</div>
            ...
            <ul style="line-height: 35px;">
                <li>Use <a href="https://git-scm.com/downloads">Git</a></li>
                <li>Automate the build</li>
                <li>Turn on all error messages</li>
            </ul>
            <div id="hierarchy-of-communication" style="font-weight: 600; margin-top: 30px; background-color:#e6ebef;">Hierarchy of communication</div>
            ...
            <span style="margin-top:30px; line-height: 35px;">The items on the top of the list are more important than the items at the bottom.</span>
            <div id="justify-exceptions-from-the-rule" style="font-weight: 600; margin-top: 30px; background-color:#e6ebef;">Justify exceptions from the rule</div>
            <span style="margin-top:30px; line-height: 35px;">Good rules work well most of the time, but there are always occasions where a rule is in the way. It’s okay to deviate from a rule when circumstances require it, but justify and document the reason.</span>
            <br><br>
            ...
            <div id="postel-law" style="font-weight: 600; margin-top: 30px; background-color:#e6ebef;">Postel’s law</div>
            <span style="margin-top:30px; line-height: 35px;">Keep <a href="https://devopedia.org/postel-s-law">Postel’s law</a> in mind for pre- and postconditions.</span>
            <br><br>
            ...
            <div id="regularly-update-dependencies" style="font-weight: 600; margin-top: 30px; background-color:#e6ebef;">Regularly update dependencies</div>
            ...
            <div id="review-code" style="font-weight: 600; margin-top: 30px; background-color:#e6ebef;">Review code</div>
            ...
            <div id="semantic-versioning" style="font-weight: 600; margin-top: 30px; background-color:#e6ebef;">Semantic Versioning</div>
            <span style="margin-top:30px; line-height: 35px;">Consider using <a href="https://devopedia.org/semantic-versioning">Semantic Versioning</a>.</span>
        </div>
        <div style="border-top: 1px solid #D2D2D2;margin-top: 50px;">
        ...
        <div style="border-top: 1px solid #D2D2D2;margin-top: 50px;">
            ...
            <span style="margin-top:30px; line-height: 35px;">This section will describe how to contribute using the git workflow (from now on called the SST Flow) used for the different delivery accelerators in the Data Science Toolkit. The flow is an extension of the <a href="https://scottchacon.com/2011/08/31/github-flow.html">GitHub flow</a> first described by Scott Chacon.
            <br>
            If you are new to git or feel like a brush-up, it is highly recommended to read <a href="https://www.simonandschuster.co.uk/books/Git-in-Practice/Mike-McQuaid/9781638352174">Git in Practice</a> by Mike McQuaid. 
            <br>
        ...
        <ul style="margin-top: 15px;">
            <li> How technical do I have to be in order to contribute?</li>
        </ul>
        <div> You don’t have to be extremely technical, you can contribute as much as you are willing to. However, you do have to have at least some basic knowledge of programming and data science </div>
        <ul style="margin-top: 15px;">
