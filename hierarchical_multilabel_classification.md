...
<li>Classification of geo-chemical layers of a region.</li>
    ...
    const htmlKeyAcceleratorFiles = `<a href="{{site.baseurl}}/images/hierarchical_multilabel_classification/HMLC_accelerator_overview_public.pdf" target="_blank">HMLC Accelerator Overview</a>`;
